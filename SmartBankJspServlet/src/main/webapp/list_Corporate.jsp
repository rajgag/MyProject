...
<body style="background-color: #93CAED">
	<div class="main">
		...
		<div class="sub">
			<h2 style="font-weight: bold; width: 70%;margin-top:15px;">List of Corporate Page</h2>
		</div>
	...
	<c:forEach var="row" items="${result.rows}">
		...
		<div style="width:20% ;height:50px ;margin:auto;margin-top: 5px;margin-left: 650px;">
			<form action="ControllerServlet" action="get" style="float:left">
			<input type="submit" value="Delete" name="action" id="delete" style="margin:5px;width: 100px;">
			<input type="hidden" value="${row.CorporateName}" name="Cname">
			
			</form>
			<form action="updateCorporate.jsp" method="get" style="float:left">
			<input type="submit" value="Modify" name="action" id="modify" style="margin:5px;width: 100px;">
			<input type="hidden" value="${row.CorporateName}" name= "CorporateName">
			</form>
			</div>
	</c:forEach>
