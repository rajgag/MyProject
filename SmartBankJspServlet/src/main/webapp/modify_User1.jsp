...
<body style="background-color: #93CAED">
	...
	<br>
	<br>
	<h2 style="text-align: center;">Select Which User to modify</h2>
	...
	<sql:query dataSource="${dbsource}" var="result">
            SELECT * from users where UserStatus="Yes" and CorporateId=<%=request.getParameter("id")%>;
      </sql:query>
	<c:forEach var="row" items="${result.rows}">

		<div class="column">
			<form action="modify_User2.jsp" method="get">
