...
<body style="background-color: #93CAED">
	<div class="main">
		...
		<div class="sub">
			<h2 style="font-weight: bold; width: 70%;margin-top:15px;">Delete Corporate Page</h2>
		</div>
	...
	<c:forEach var="row" items="${result.rows}">
		...
		<div class="column">
			<a href="ControllerServlet?CorporateName=${row.CorporateName}&action=delete"><Button id="btn">
				<h2>
