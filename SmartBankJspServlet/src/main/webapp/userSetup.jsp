...
<title>SmartBank|UserSetUp</title>
<link rel="stylesheet"
...
<body  style="background-color:#93CAED;">
	<div class="main">
		...
		<div class="sub">
			<h2 style="font-weight: bold; width: 70%">User Setup Page</h2>
		</div>
	...
	<div style="height: 200px; padding: 20px; text-align: center;">
		<a href="add_User1.jsp"><button id="btn">
				<h4>Add User</h4>
			</button></a> <a href="modify_User.jsp"><button id="btn">
				<h4>Modify User</h4>
			</button></a> <a href="delete_User.jsp"><button id="btn">
				<h4>Delete User</h4>
			</button></a>
			<a href="list_User.jsp"><button id="btn">
				<h4>List of Users</h4>
			</button></a>
