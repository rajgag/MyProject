...
<body style="background-color: #93CAED">
	<div class="main">
		...
		<div class="sub">
			<h2 style="font-weight: bold; width: 70%">Account Setup Page</h2>
		</div>
	...
	<div style="height: 200px; padding: 20px; text-align: center;">
		<a href="add_Account.jsp"><button id="btn">
				<h4>Add Account</h4>
			</button></a> <a href="close_Account.jsp"><button id="btn">
				<h4>Close Account</h4>
			</button></a> <a href="list_Account.jsp"><button id="btn">
				<h4>View Account List</h4>
			</button></a>
