...
<body style="background-color: #93CAED">
	<div class="main">
		...
		<div class="sub">
			<h2 style="font-weight: bold; width: 70%;margin-top:15px;">Delete User Page</h2>
		</div>
	...
	<c:forEach var="row" items="${result.rows}">
		<div class="column">
		<form action="UserServlet" action="get">
			<a href=""><Button type="submit" id="btn">
				<h2>
					<c:out value="${row.UserLoginId}" />
				</h2>
			</Button></a>
			<input type="hidden" value="${row.CorporateId}" name="CorporateId">
			<input type="hidden" value="${row.UserLoginId}" name= "UserLoginId">
