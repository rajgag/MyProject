...
<body style="background-color: #93CAED">
	<div class="main">
		<div class="sub" style="width: 15%; padding-top: 25px;">
			<a href="modify_User.jsp"
				style="text-decoration: none; color: black; margin-left: 10px;">Back</a>
		</div>
		<div class="sub">
			<h2 style="font-weight: bold; width: 70%;margin-top:15px;">Modify User Page</h2>
		</div>
	...
	<div class="main-section">
		<div class="content-section">
			<div class="head-section">
				<h3>Modify User Form</h3>
			</div>
			<div class="body-section">
				<form action="UserServlet" method="get">
					<div class="form-input">
						<input type="text" name="UserLoginId" id="address"
							value="<%=request.getParameter("id1") %>" readonly="readonly">
					</div>
					<div class="form-input">
						<input type="text" name="UserAdd" id="address"
							value="<%=request.getParameter("id2") %>" required="required">
					</div>
					<div class="form-input">
						<input type="text" name="UserDept" id="address"
							value="<%=request.getParameter("id3") %>" required="required">
					</div>
					<div class="form-input">
						<input type="tel" name="UserPhno" value="<%=request.getParameter("id4") %>"
							required="required">
					</div>
					<div class="form-input">
