...
<body style="background-color: #93CAED">
	<div class="main">
		...
		<div class="sub">
			<h2 style="font-weight: bold; width: 70%; margin-top: 15px;">Add
				User Page</h2>
		</div>
		...
		<div class="content-section">
			...
			<div class="body-section">
				<form action="AccountServlet" method="get">
					...
					<div class="form-input">
						<input type="text" name="AccountNo" id="address"
							placeholder="Account-Number" required="required">
					</div>
					<div class="form-input">
						<input type="text" name="AccountName" id="address"
							placeholder="Account-Name" required="required">
					</div>
					<div class="form-input">
							<select  id="address" name="AccountBranch">
					...
					<div class="form-input">
						<select id="address" name="Currency">
					...
					<div class="form-input">
						<input type="tel" name="AvailableBalance"
							placeholder="Available-Balance" required="required">
					</div>
					<div class="form-input">
